    ...
    <div className='homefeature-container'>
        <div className='homefeature-wrapper'>
            <motion.div className="homefeature-box"
                variants={opacityVariant('left', '100%', 'tween', 0, .5)}
                initial='hidden'
                whileInView='show'
                whileHover={{ y: '-5%' ,
                transition: {
            ...
            <motion.div className="homefeature-box sunset"
                variants={opacityVariant('left', '100%', 'tween', 0.1, .5)}
                initial='hidden'
                whileInView='show'
                whileHover={{ y: '-5%' ,
                transition: {
            ...
            <motion.div className="homefeature-box voyage"
                variants={opacityVariant('left', '100%', 'tween', 0.2, .5)}
                initial='hidden'
                whileInView='show'
                whileHover={{ y: '-5%' ,
                transition: {
            ...
            <motion.div className="homefeature-box architecturals"
                variants={opacityVariant('left', '100%', 'tween', 0.3, .5)}
                initial='hidden'
                whileInView='show'
                whileHover={{ y: '-5%' ,
                transition: {
